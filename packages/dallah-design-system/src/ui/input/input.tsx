    ...
    return (
      <input
        ...
        className={cn(
          ...
          'text-text-lg rounded-lg flex h-12 items-center gap-[0.5rem] self-stretch border-[0.0625rem] border-solid border-[#D0D5DD] bg-[#FFFDF9] px-[0.875rem] py-[10px] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)] transition-colors duration-500 focus:outline-none',
          className,
        )}
        ref={ref}
        {...props}
