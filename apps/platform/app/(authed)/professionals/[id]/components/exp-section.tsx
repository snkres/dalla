      ...
      <div className="p-4">
        {isEditing ? (
          <div className="space-y-8">
            {editedExperiences.map((exp, companyIndex) => (
              <div
                key={companyIndex}
                className={cn(
              ...
              >
                ...
                <div className="ml-1 space-y-6 sm:ml-2">
                  ...
                  >
                    {/* Render the experience directly */}
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <Textarea
                          ...
                          className="min-h-[60px] rounded-md border border-gray-200 text-xs focus:border-[#63B7B7] focus:ring-0"
                        />
                      </div>
