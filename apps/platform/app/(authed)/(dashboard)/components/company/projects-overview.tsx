        ...
        <div className="flex items-center justify-between border-b border-gray-200 p-5">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-base font-medium text-gray-900">
              {t.dashboard.companyComponents.projectsOverview.title}
            </h2>
          </div>
            ...
            <div key="projects-list">
              <div className="divide-y divide-gray-100">
                {projects
                  ...
                  .slice(0, 5)
                  .map((project) => {
                    const badgeText = project.approved
                      ? project.professional
                        ? t.dashboard.companyComponents.projectsOverview
                            .badgeHired
                        : project.proposals.length > 0
                          ? t.dashboard.companyComponents.projectsOverview
                              .badgeReceivedProposals
                          : t.dashboard.companyComponents.projectsOverview
                              .badgeNoProposals
                      : t.dashboard.companyComponents.projectsOverview
                          .badgeNotApproved
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <div className="mt-0.5 flex items-center gap-2">
                                  ...
                                  <span className="text-xs text-gray-500">
                                    {
                                      t.dashboard.companyComponents
                                        .projectsOverview.postedDatePrefix
                                    }{' '}
                                    {new Date(
                                      project.createdAt,
                            ...
                            <div className="flex items-center gap-2">
                              {project.proposals.length > 0 &&
                                project.status !== 'InProgress' && (
                                  ...
                                  >
                                    {t.dashboard.companyComponents.projectsOverview.proposalsCountBadge.replace(
                                      '{count}',
                                      project.proposals.length.toString(),
                                    )}
                                  </Badge>
                                )}
                                ...
                                {project.status === 'Open' && (
                                  <>
                                    ...
                                    >
                                      ...
                                      {
                                        t.dashboard.companyComponents
                                          .projectsOverview.viewProposalsButton
                                      }
                                    </Button>
                                  </>
                                )}
