...
export function UnlockingSuccess() {
  return (
    <section className="flex gap-[6.375rem] bg-white px-[10.313rem]">
      <div className="container-fluid flex flex-col gap-8 py-[2.5rem]">
        ...
        <div className="flex flex-col items-center gap-10 md:flex-row">
          <div className="space-y-5 text-center md:text-left">
            ...
            <div className="text-slate-blue text-text-xl font-bold">
              Secure Payment
            </div>
          ...
          <div className="space-y-5 text-center md:text-left">
            ...
            <div className="text-slate-blue font-bold">Localized Support</div>
            <p className="text-[#594D6D]">
